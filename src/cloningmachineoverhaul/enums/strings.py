...
class Strings:
    ...
    class RelbitMenu(enum.Int):
        RELBIT_MENU_TITLE = 0xD588A7E2
        RELBIT_MENU_DESC = 0xB65E5700
    ...
    class DnaPickerMenu(enum.Int):
        DNA_PICKER_DIALOG_TITLE = 0x0E556257
        DNA_PICKER_DIALOG_DESC = 0x9E93258A

    class SimNameMenu(enum.Int):
        RENAME_SIM_DIALOG_TITLE = 0x3968E751
        RENAME_SIM_DIALOG_DESC = 0xC0529518
        RENAME_SIM_DIALOG_FIRST_NAME_TITLE = 0xEAEC1FC4
        RENAME_SIM_DIALOG_LAST_NAME_TITLE = 0x24353B70
        RENAME_SIM_DIALOG_TOOLTIP = 0x1376CB38
